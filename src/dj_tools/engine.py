...
BAR_MITZVAH_QUESTIONS = [
    {"id": "guest_name",       "label": "Bar Mitzvah celebrant name",         "type": "text"},
    {"id": "event_date",       "label": "Event date",                         "type": "date"},
    {"id": "venue_name",       "label": "Venue name & address",               "type": "text"},
    {"id": "guest_count",      "label": "Estimated guest count",              "type": "number"},
    {"id": "service_time",     "label": "Service time (if same day)",         "type": "time"},
    {"id": "party_start",      "label": "Party start time",                   "type": "time"},
    {"id": "party_end",        "label": "Party end time",                     "type": "time"},
    {"id": "entrance_song",    "label": "Grand entrance song",                "type": "text"},
    {"id": "candle_lighting",  "label": "Candle lighting ceremony song (if any)", "type": "text"},
    {"id": "cake_cutting_song","label": "Cake cutting song",                  "type": "text"},
    {"id": "special_dances",   "label": "Special dances or traditions",       "type": "textarea"},
    {"id": "must_play",        "label": "Must-play songs",                    "type": "textarea"},
    {"id": "do_not_play",      "label": "Do-NOT-play songs or genres",        "type": "textarea"},
    {"id": "vibe",             "label": "Desired vibe / energy",              "type": "textarea"},
    {"id": "special_requests", "label": "Anything else?",                     "type": "textarea"},
...
BAT_MITZVAH_QUESTIONS = [
    {"id": "guest_name",       "label": "Bat Mitzvah celebrant name",         "type": "text"},
    {"id": "event_date",       "label": "Event date",                         "type": "date"},
    {"id": "venue_name",       "label": "Venue name & address",               "type": "text"},
    {"id": "guest_count",      "label": "Estimated guest count",              "type": "number"},
    {"id": "service_time",     "label": "Service time (if same day)",         "type": "time"},
...
ANNIVERSARY_QUESTIONS = [
    ...
    {"id": "cake_cutting_song", "label": "Cake cutting song",                 "type": "text"},
    {"id": "special_moments",   "label": "Speech toasts or special moments",  "type": "textarea"},
